...
pub use d3d::{create_d3d_device, create_direct3d_device, get_d3d_interface_from_object};

pub use windows::core::{ComInterface, IInspectable, Result, HSTRING};
...
pub use windows::Win32::Graphics::Gdi::{MonitorFromWindow, HMONITOR, MONITOR_DEFAULTTOPRIMARY};
pub use windows::Win32::System::WinRT::{
    Graphics::Capture::IGraphicsCaptureItemInterop, RoInitialize, RO_INIT_MULTITHREADED,
};
pub use windows::Win32::UI::WindowsAndMessaging::{GetDesktopWindow, GetWindowThreadProcessId};

use capture::enumerate_capturable_windows;
pub use display_info::enumerate_displays;
use std::io::Write;
...
pub fn take_screenshot(item: &GraphicsCaptureItem) -> Result<()> {
